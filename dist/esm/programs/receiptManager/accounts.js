...
export const getAllreceiptManagers = async (connection, commitment) =>
  getAllOfType(connection, "receiptManager", commitment);
...
export const getAllRewardReceipts = async (connection, commitment) =>
  getAllOfType(connection, "rewardReceipt", commitment);
