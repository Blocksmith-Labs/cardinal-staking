...
import { IDENTIFIER_SEED, STAKE_AUTHORIZATION_SEED, STAKE_BOOSTER_SEED, } from "./constants";
/**
 ...
 * @returns
 */
export const findStakeEntryId = async (wallet, stakePoolId, originalMintId, isFungible) => {
    return web3.PublicKey.findProgramAddress([
