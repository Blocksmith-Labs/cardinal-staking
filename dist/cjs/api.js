...
const initializeRewardEntry = async (connection, wallet, params) => {
  ...
  const rewardDistributorId = (0, pda_3.findRewardDistributorId)(
    params.stakePoolId
  );
...
const createStakeEntryAndStakeMint = async (connection, wallet, params) => {
  ...
  if (
    ...
    const stakePool = await (0, accounts_3.getStakePool)(
      connection,
      params.stakePoolId
    );
...
const claimRewards = async (connection, wallet, params) => {
  ...
  const rewardEntryIds = params.stakeEntryIds.map((stakeEntryId) =>
    (0, pda_3.findRewardEntryId)(rewardDistributorId, stakeEntryId)
  );
  /////// get accounts ///////
  const rewardDistributorData = await (0, common_1.tryNull)(() =>
  ...
  const rewardEntryInfos = await (0, common_1.getBatchedMultipleAccounts)(
    connection,
    rewardEntryIds
  );
  const rewardMintTokenAccountId = (0,
  spl_token_1.getAssociatedTokenAddressSync)(
    rewardDistributorData.parsed.rewardMint,
    (_a = params.lastStaker) !== null && _a !== void 0 ? _a : wallet.publicKey,
    true
  );
  const txs = [];
  for (let i = 0; i < params.stakeEntryIds.length; i++) {
    ...
    tx.add(
      (0, spl_token_1.createAssociatedTokenAccountIdempotentInstruction)(
        ...
        (_c = params.lastStaker) !== null && _c !== void 0
          ? _c
          : wallet.publicKey,
        rewardDistributorData.parsed.rewardMint
      )
    ...
    /////// init entry ///////
    if (
      !((_d = rewardEntryInfos[i]) === null || _d === void 0 ? void 0 : _d.data)
    ) {
      const ix = await (0, rewardDistributor_1.rewardDistributorProgram)(
        connection,
        wallet
      )
        ...
        .accounts({
          ...
          payer:
            (_e = params.payer) !== null && _e !== void 0
              ? _e
              : wallet.publicKey,
    ...
    const ix = await (0, rewardDistributor_1.rewardDistributorProgram)(
      ...
      .accounts({
        ...
        user:
          (_f = params.payer) !== null && _f !== void 0 ? _f : wallet.publicKey,
        tokenProgram: spl_token_1.TOKEN_PROGRAM_ID,
        systemProgram: web3_js_1.SystemProgram.programId,
      })
      .remainingAccounts([
        {
          pubkey: (0, spl_token_1.getAssociatedTokenAddressSync)(
            rewardDistributorData.parsed.rewardMint,
...
const claimRewardsAll = async (connection, wallet, params) => {
  ...
  const rewardDistributorData = await (0, accounts_2.getRewardDistributor)(
    connection,
    rewardDistributorId
  );
  const rewardMintId = rewardDistributorData.parsed.rewardMint;
  const userRewardTokenAccountId = (0,
  spl_token_1.getAssociatedTokenAddressSync)(
    rewardMintId,
    wallet.publicKey,
    true
  );
  const rewardTokenAccount = await (0, common_1.tryNull)(
    (0, spl_token_1.getAccount)(connection, userRewardTokenAccountId)
  );
    ...
    mintInfos: [
      {
        ...
        fungible:
          (_a = params.fungible) !== null && _a !== void 0
            ? _a
            : params.amount && params.amount.gt(new anchor_1.BN(1)),
...
const stakeAll = async (connection, wallet, params) => {
  ...
  const mintInfos = params.mintInfos.map(({ mintId, fungible, ...rest }) => ({
    ...
    mintId,
    fungible,
    stakeEntryId: (0, pda_4.findStakeEntryId)(
      wallet.publicKey,
      params.stakePoolId,
      mintId,
      fungible !== null && fungible !== void 0 ? fungible : false
    ),
  }));
  /////// get accounts ///////
  ...
  const mintInfosWithReceipts = mintInfos.filter(
    (i) => i.receiptType === stakePool_1.ReceiptType.Receipt
  );
  ...
  if (mintInfosWithReceipts.length > 0) {
    for (let i = 0; i < mintInfosWithReceipts.length; i++) {
      ...
      const transaction = new web3_js_1.Transaction();
      const stakeEntryInfo =
        (_a = accountData[stakeEntryId.toString()]) !== null && _a !== void 0
          ? _a
          : null;
      const stakeEntryData = stakeEntryInfo
        ? (0, common_1.tryDecodeIdlAccount)(
            stakeEntryInfo,
            "stakeEntry",
            stakePool_1.STAKE_POOL_IDL
          )
        : null;
      const stakePoolInfo =
        (_b = accountData[params.stakePoolId.toString()]) !== null &&
        _b !== void 0
          ? _b
          : null;
      if (!stakePoolInfo) throw "Stake pool not found";
      const stakePoolData = (0, common_1.decodeIdlAccount)(
        stakePoolInfo,
        "stakePool",
        stakePool_1.STAKE_POOL_IDL
      );
      if (!stakeEntryInfo) {
        const ix = await (0, stakePool_1.stakePoolProgram)(connection, wallet)
          ...
          .remainingAccounts(
            (0, utils_1.remainingAccountsForInitStakeEntry)(
              params.stakePoolId,
              mintId
            )
          )
      ...
      if (
        !((_c =
          stakeEntryData === null || stakeEntryData === void 0
            ? void 0
            : stakeEntryData.parsed) === null || _c === void 0
          ? void 0
          : _c.stakeMint)
      ) {
        stakeMintKeypair = web3_js_1.Keypair.generate();
  ...
  for (let i = 0; i < mintInfos.length; i++) {
    ...
    const metadataAccountInfo =
      (_d = accountData[mintMetadataId.toString()]) !== null && _d !== void 0
        ? _d
        : null;
    const mintMetadata = metadataAccountInfo
      ...
      : null;
    const stakeEntryInfo =
      (_e = accountData[stakeEntryId.toString()]) !== null && _e !== void 0
        ? _e
        : null;
    const stakeEntryData = stakeEntryInfo
      ? (0, common_1.tryDecodeIdlAccount)(
    ...
    if (
      ...
      /////// programmable ///////
      transaction.add(
        await (0, stakePool_1.stakePoolProgram)(connection, wallet)
          .methods.stakeProgrammable(
            amount !== null && amount !== void 0 ? amount : new anchor_1.BN(1)
          )
          .accountsStrict({
            stakeEntry: stakeEntryId,
            stakePool: params.stakePoolId,
            ...
            userOriginalMintTokenRecord: (0, common_1.findTokenRecordId)(
              originalMintId,
      ...
      /////// non-programmable ///////
      const stakeEntryOriginalMintTokenAccountId = (0,
      spl_token_1.getAssociatedTokenAddressSync)(
        originalMintId,
        stakeEntryId,
        true
      ...
      if (receiptType && receiptType !== stakePool_1.ReceiptType.None) {
        const receiptMintId =
          receiptType === stakePool_1.ReceiptType.Receipt
            ? (_h = mintReceiptIds[originalMintId.toString()]) !== null &&
              _h !== void 0
              ? _h
              : (_j =
                  stakeEntryData === null || stakeEntryData === void 0
                    ? void 0
                    : stakeEntryData.parsed) === null || _j === void 0
              ? void 0
              : _j.stakeMint
            : originalMintId;
        if (!receiptMintId) {
        ...
        if (
          ((_k =
            stakeEntryData === null || stakeEntryData === void 0
              ? void 0
              : stakeEntryData.parsed) === null || _k === void 0
            ? void 0
            : _k.stakeMintClaimed) ||
          ((_l =
            stakeEntryData === null || stakeEntryData === void 0
              ? void 0
              : stakeEntryData.parsed) === null || _l === void 0
            ? void 0
            : _l.originalMintClaimed)
        ) {
        ...
        if (
          ...
          const tokenManagerId = (0, pda_1.findTokenManagerAddress)(
            receiptMintId
          );
          const tokenManagerReceiptMintTokenAccountId = (0,
          spl_token_1.getAssociatedTokenAddressSync)(
            receiptMintId,
            tokenManagerId,
            true
          ...
          const ix = await (0, stakePool_1.stakePoolProgram)(connection, wallet)
            ...
            .accounts({
              ...
              stakeEntryReceiptMintTokenAccount: (0,
              spl_token_1.getAssociatedTokenAddressSync)(
                receiptMintId,
                stakeEntryId,
                true
...
const unstakeAll = async (connection, wallet, params) => {
  ...
  const mintInfos = params.mintInfos.map(
    ({ mintId, fungible, stakeEntryId }) => ({
      ...
      userOriginalMintTokenAccountId: (0,
      spl_token_1.getAssociatedTokenAddressSync)(mintId, wallet.publicKey),
      stakeEntryId:
        stakeEntryId !== null && stakeEntryId !== void 0
          ? stakeEntryId
          : (0, pda_4.findStakeEntryId)(
              wallet.publicKey,
              params.stakePoolId,
              mintId,
              fungible !== null && fungible !== void 0 ? fungible : false
  ...
  const accountData = await (0, common_1.fetchAccountDataById)(connection, [
    ...
    ...mintInfos.map(({ mintId, userOriginalMintTokenAccountId }) =>
      (0, common_1.findTokenRecordId)(mintId, userOriginalMintTokenAccountId)
    ),
  ]);
  const stakePoolInfo = accountData[params.stakePoolId.toString()];
  if (
    !(stakePoolInfo === null || stakePoolInfo === void 0
      ? void 0
      : stakePoolInfo.data)
  )
  ...
  const rewardMintId =
    (_a =
      rewardDistributorData === null || rewardDistributorData === void 0
        ? void 0
        : rewardDistributorData.parsed) === null || _a === void 0
      ? void 0
      : _a.rewardMint;
  ...
  for (const {
    ...
    if (
      ...
      const updateIx = await (0, stakePool_1.stakePoolProgram)(
        connection,
        wallet
      )
      ...
      tx.add(updateIx);
      /////// claim rewards ///////
      const rewardEntryId = (0, pda_3.findRewardEntryId)(
        rewardDistributorId,
        stakeEntryId
      );
      const rewardEntry = await (0, common_1.tryGetAccount)(() =>
        (0, accounts_2.getRewardEntry)(connection, rewardEntryId)
      );
      if (!rewardEntry) {
        const ix = await (0, rewardDistributor_1.rewardDistributorProgram)(
          connection,
          ...
          .methods.initRewardEntry()
          .accountsStrict({
            rewardEntry: (0, pda_3.findRewardEntryId)(
              rewardDistributorId,
              stakeEntryId
            ),
      ...
      const stakeEntryData = (0, common_1.decodeIdlAccount)(
        stakeEntryInfo,
        "stakeEntry",
        stakePool_1.STAKE_POOL_IDL
      );
    ...
    if (
      ...
      if (
        ...
        const ix = await program.methods
          ...
          .accountsStrict({
            ...
            user: wallet.publicKey,
            userOriginalMintTokenAccount: userOriginalMintTokenAccountId,
            stakeEntryOriginalMintTokenRecord: (0, common_1.findTokenRecordId)(
              originalMintId,
              stakeEntryOriginalMintTokenAccountId
            ),
            userOriginalMintTokenRecord: (0, common_1.findTokenRecordId)(
      ...
      const stakeEntry = (0, common_1.decodeIdlAccount)(
        stakeEntryInfo,
        "stakeEntry",
        stakePool_1.STAKE_POOL_IDL
      );
      if (
        ...
        const tokenManagerData = await (0, common_1.tryNull)(() =>
        ...
        if (
          tokenManagerData &&
          (0, utils_1.shouldReturnReceipt)(
            stakePoolData.parsed,
            stakeEntry.parsed
          )
        ) {
          const remainingAccounts = await (0,
          tokenManager_1.withRemainingAccountsForInvalidate)(
            tx,
            connection,
            wallet,
            receiptMint,
  ...
  if (userRewardTokenAccountId && rewardMintId) {
    rewardTokenAccount = await (0, common_1.tryNull)(
      (0, spl_token_1.getAccount)(connection, userRewardTokenAccountId)
    );
  }
...
const claimGroupRewards = async (connection, wallet, params) => {
  ...
  if (!groupRewardEntry) {
    const stakeEntriesData = await (0, accounts_3.getStakeEntries)(
      connection,
