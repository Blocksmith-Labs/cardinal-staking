...
const getReceiptManager = async (connection, receiptManagerId, commitment) => {
  const program = (0, constants_1.receiptManagerProgram)(
    connection,
    undefined,
    { commitment }
  );
...
const getAllreceiptManagers = async (connection, commitment) =>
  (0, exports.getAllOfType)(connection, "receiptManager", commitment);
exports.getAllreceiptManagers = getAllreceiptManagers;
const getReceiptManagersForPool = async (
  connection,
  stakePoolId,
  commitment
) => {
...
const getAllRewardReceipts = async (connection, commitment) =>
  (0, exports.getAllOfType)(connection, "rewardReceipt", commitment);
exports.getAllRewardReceipts = getAllRewardReceipts;
const getRewardReceiptsForManager = async (
  connection,
  rewardDistributorId,
  commitment
) => {
...
const getClaimableRewardReceiptsForManager = async (
  ...
  const ReceiptManagerData = await (0, common_1.tryGetAccount)(() =>
    (0, exports.getReceiptManager)(connection, receiptManagerId, commitment)
  );
  if (!ReceiptManagerData) {
