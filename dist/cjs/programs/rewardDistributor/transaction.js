...
const withInitRewardEntry = async (transaction, connection, wallet, params) => {
    const [rewardEntryId] = await (0, pda_1.findRewardEntryId)(params.rewardDistributorId, params.stakeEntryId);
...
const withClaimRewards = async (transaction, connection, wallet, params) => {
    ...
    if (rewardDistributorData) {
        ...
        const [rewardEntryId] = await (0, pda_1.findRewardEntryId)(rewardDistributorData.pubkey, params.stakeEntryId);
        ...
        transaction.add(await (0, instruction_1.claimRewards)(connection, wallet, {
            stakePoolId: params.stakePoolId,
            stakeEntryId: params.stakeEntryId,
...
const withCloseRewardDistributor = async (transaction, connection, wallet, params) => {
    ...
    if (rewardDistributorData) {
        ...
        transaction.add(await (0, instruction_1.closeRewardDistributor)(connection, wallet, {
            stakePoolId: params.stakePoolId,
            rewardMintId: rewardDistributorData.parsed.rewardMint,
            remainingAccountsForKind,
        }));
...
const withUpdateRewardEntry = async (transaction, connection, wallet, params) => {
    return transaction.add(await (0, instruction_1.updateRewardEntry)(connection, wallet, {
        stakePoolId: params.stakePoolId,
        stakeEntryId: params.stakeEntryId,
