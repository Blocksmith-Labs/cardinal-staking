...
const withInitStakeEntry = async (transaction, connection, wallet, params) => {
  const ix = await (0, constants_1.stakePoolProgram)(connection, wallet)
    ...
    .accountsStrict({
      ...
      originalMintMetadata: (0, common_1.findMintMetadataId)(
...
const withAuthorizeStakeEntry = async (
  ...
  const ix = await (0, constants_1.stakePoolProgram)(connection, wallet)
    ...
    .accounts({
      stakePool: params.stakePoolId,
      stakeAuthorizationRecord: (0, pda_2.findStakeAuthorizationId)(
        params.stakePoolId,
        params.originalMintId
      ),
      payer: wallet.publicKey,
...
const withDeauthorizeStakeEntry = async (
  ...
  const stakeAuthorizationId = (0, pda_2.findStakeAuthorizationId)(
    params.stakePoolId,
    params.originalMintId
  );
  const program = (0, constants_1.stakePoolProgram)(connection, wallet);
...
const withInitStakeMint = async (transaction, connection, wallet, params) => {
  ...
  const stakeEntryStakeMintTokenAccountId = (0,
  ...
  const ix = await program.methods
    ...
    .accounts({
      ...
      mintManager: (0, pda_1.findMintManagerId)(
        params.stakeMintKeypair.publicKey
      ),
      payer: wallet.publicKey,
...
const withInitStakeBooster = async (
  ...
  const stakeBoosterId = (0, pda_2.findStakeBoosterId)(
    params.stakePoolId,
...
const withBoostStakeEntry = async (transaction, connection, wallet, params) => {
  ...
  const stakeBooster = await (0, accounts_2.getStakeBooster)(
    connection,
    stakeBoosterId
  );
