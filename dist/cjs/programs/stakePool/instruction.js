...
exports.closeStakeBooster =
  exports.updateStakeBooster =
  exports.initStakeBooster =
  exports.reassignStakeEntry =
  exports.closeStakeEntry =
  exports.closeStakePool =
  exports.returnReceiptMint =
  exports.updateTotalStakeSeconds =
  exports.updateStakePool =
  exports.unstake =
  exports.stake =
  exports.claimReceiptMint =
  exports.initStakeMint =
  exports.initStakeEntry =
  exports.deauthorizeStakeEntry =
  exports.authorizeStakeEntry =
  exports.initStakePool =
...
const authorizeStakeEntry = async (connection, wallet, params) => {
  ...
  const [stakeAuthorizationId] = await (0, pda_2.findStakeAuthorizationId)(
    params.stakePoolId,
...
const initStakeEntry = async (connection, wallet, params) => {
  ...
  utils_1.remainingAccountsForInitStakeEntry)(
    params.stakePoolId,
    params.originalMintId
  );
...
const returnReceiptMint = async (connection, wallet, params) => {
  ...
  const tokenManagerTokenAccountId = await (0, common_1.findAta)(
    params.receiptMint,
    (
      await (0, pda_1.findTokenManagerAddress)(params.receiptMint)
    )[0],
    true
  );
  const userReceiptMintTokenAccount = await (0, common_1.findAta)(
    params.receiptMint,
    wallet.publicKey,
    true
  );
...
const initStakeBooster = async (connection, wallet, params) => {
  ...
  const [stakeBoosterId] = await (0, pda_2.findStakeBoosterId)(
    params.stakePoolId,
