...
exports.findStakeBoosterId = exports.findStakeAuthorizationId = exports.findIdentifierId = exports.findStakeEntryId = exports.findStakePoolId = void 0;
 ...
 * @returns
 */
const findStakeEntryId = async (wallet, stakePoolId, originalMintId, isFungible) => {
    return web3.PublicKey.findProgramAddress([
